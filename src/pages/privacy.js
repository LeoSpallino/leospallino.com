  ...
  return (
    <Layout>
      ...
      <div>
        ...
        <p>
          At leospallino.com, accessible from https://www.leospallino.com, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by leospallino.com and how we use it.
        </p>
        ...
        <p>
          Leo Spallino legal basis for collecting and using the personal
        ...
        <ul>
          <li>Leo Spallino needs to perform a contract with you</li>
          <li>You have given Leo Spallino permission to do so</li>
          <li>
            Processing your personal information is in Leo Spallino legitimate
            interests
          </li>
          <li>Leo Spallino needs to comply with the law</li>
        </ul>

        <p>
          Leo Spallino will retain your personal information only for as long as
        ...
        <p>
          leospallino.com follows a standard procedure of using log files. These
        ...
        <p>
          ...
          advertising partners of leospallino.com.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on leospallino.com, which are
        ...
        <p>
          Note that leospallino.com has no access to or control over these
        ...
        <p>
          leospallino.com's Privacy Policy does not apply to other advertisers
        ...
        <p>
          leospallino.com does not knowingly collect any Personal Identifiable
        ...
        <p>
          ...
          leospallino.com. This policy is not applicable to any information
